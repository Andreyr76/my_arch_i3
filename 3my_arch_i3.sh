...
sudo pacman -S reflector firefox firefox-i18n-ru ufw f2fs-tools dosfstools ntfs-3g alsa-lib alsa-utils file-roller p7zip unrar gvfs aspell-ru pulseaudio pavucontrol youtube-dl ranger pcmanfm jq pacman-contrib sakura speedtest-cli peek --noconfirm

sudo pacman -S chromium flameshot veracrypt vlc freemind filezilla gimp libreoffice libreoffice-fresh-ru neofetch qbittorrent screenfetch telegram-desktop gparted evince keepassxc nano vim neovim featherpad fbreader audacious git ktouch klavaro clamtk mc htop tmux unrar zip ark gnome-disk-utility gedit uget viewnior smplayer smtube --noconfirm

gpg --keyserver keys.gnupg.net --recv-keys FC918B335044912E 

yay -Syy
yay -S xflux hunspell-ru pamac-aur conky-lua tusk vscodium-bin figma-linux xorg-xkill etcher-bin dropbox polybar ttf-weather-icons ttf-clear-sans tlp playerctl ttf-symbola ttf-clear-sans --noconfirm
